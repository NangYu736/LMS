                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach($categories as $category)
                                        {
                                            ...
                                            echo "<td id='" .$category['id'] ."'> <a class='btn btn-warning mx-3' href='edit_category.php?id=".$category['id']."'>Edit</a><button class='btn btn-danger mx-3 cat_delete'>Delete</button> </td>";
                                            echo "<tr>";
                                        }
                                    ?>
